...
<TD WIDTH="100%" ALIGN="CENTER"><!---<CFIF FileExists('#GetDirectoryFromPath(ExpandPath("*.*"))#/pictures/albumcover/small/#trim(album.Artist)#-#trim(album.Name)#.jpg')>---><cfoutput><A HREF="pictures/albumcover/#trim(album.Artist)#-#trim(album.Name)#.jpg"><IMG CLASS="pic" SRC="pictures/albumcover/small/#URLencodedFormat(album.Artist)#-#URLencodedFormat(trim(album.Name))#.jpg"  BORDER="0" title='#album.Artist#-#trim(general.Name)#'></A></cfoutput><!---<CFELSE><IMG SRC="pictures/albumcover/small/generic.jpg" name='SlideShow' ALIGN="TOP" ></CFIF>---></TD> 
</TR>
...
<!---				<SPAN>Update Required</SPAN>
					To play the media you will need to either update your browser to a recent version or update your <A HREF="http://get.adobe.com/flashplayer/" TARGET="">Flash plugin</A>.
				</DIV> --->
			</DIV>
		</DIV></TD>
		</TR>
