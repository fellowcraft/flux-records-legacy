...
<HEAD>
<TITLE><CFOUTPUT>#records.recordcount# albums #A.recordcount# works #chr(169)# ROTHKAMM 1982-#DateFormat(now(),'YYYY')#
</CFOUTPUT>
</TITLE>
...
<TD  ALIGN="CENTER" 
    VALIGN="TOP"><A HREF='album.cfm?#URLAlbum#'><IMG CLASS="pic" SRC='#AlbumImage#' BORDER="0"></A></TD>
