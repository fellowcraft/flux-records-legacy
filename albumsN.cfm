...
<CFOUTPUT>
#records.recordcount# albums ( #solo.recordcount# solo | #other.recordcount# for or with others | #Evaluate(records.recordcount - solo.recordcount - other.recordcount)# to be released ) composed 1982-#DateFormat(now(),'YYYY')#
