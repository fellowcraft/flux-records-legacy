...
<HEAD>
<TITLE>Frank Rothkamm | <CFOUTPUT>#all.Parts#</CFOUTPUT> works | 1982-2017</TITLE>
...
<!--- album icon --->
<TD ALIGN="center" VALIGN="middle" CLASS="style3" ><CFIF trim(album) NEQ ''><CFLOOP list="#album#" delimiters="^" index="calbum">
<cfquery datasource="#ds#" name="AlbumArtist">
select Artist from Album where Name like '#calbum#' 
</cfquery><CFSET album_icon = "#AlbumArtist.Artist#-#calbum#" ><!--- #AlbumArtist.recordcount# #calbum#---><A HREF='http://rothkamm.com/album.cfm?#URLencode(trim(calbum))#'><!---<CFIF FileExists('#GetDirectoryFromPath(ExpandPath("*.*"))#pictures/albumcover/small/#album_icon#.jpg')>---><IMG SRC="pictures/albumcover/small/#URLencode(album_icon)#.jpg" WIDTH="40" ALIGN="ABSMIDDLE" BORDER="0" Title='Released on album "#trim(calbum)#"'><!---<CFELSE><IMG SRC="pictures/icons/noalbum.jpg" width="30"  height="30" ALIGN="ABSMIDDLE" BORDER="0" Title='To be released on album "#trim(calbum)#"'> </A></CFIF>---></CFLOOP></CFIF>&nbsp;<!--- <br /><img src="pictures/shim.gif" width="20" height="5"> ---></TD>
...
<TD VALIGN="top" CLASS="style3c"><A HREF='work.cfm?opus=#ID#'><CFIF status EQ 0><strike></CFIF><B>#name#</B></A> <SPAN CLASS="style2cfade">#WorkLength#</SPAN><br>
    <span class="style2cfade">#Replace(artist,","," ","ALL")#
...
<TR>
 <TD COLSPAN="5"><IMG SRC="pictures/shim.gif" WIDTH="10" HEIGHT="5"></TD>
