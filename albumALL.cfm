...
select * from Album
where Name COLLATE UTF8_GENERAL_CI like '#ReReplace(URLDecode(QUERY_STRING),"(%20|-)"," ","ALL")#'
LIMIT 1 
</CFQUERY>
...
<HEAD>
<TITLE><CFOUTPUT>#album.Artist#-#album.Name# (#album.Composed#) #album.NameExt#</CFOUTPUT></TITLE>
...
if (locMP3 EQ "") msg = "[file missing]" 
		...
		{
			title:'<cfoutput><b>[#currentrow#]</b/> #REReplace(tracks.name,"(#chr(10)#|#chr(13)#|')"," ","ALL")# (#Evaluate(int(tracks.length/60))#:#NumberFormat(Evaluate(tracks.length mod 60),'00')#) opus #tracks.ID# (#year#) #msg# <br><a href="work.cfm?opus=#tracks.ID#" target="_blank"><img src="pictures/download_3.gif" border=0 WIDTH="20" hspace=5" align="middle"></a></cfoutput>',
...
<link rel="shortcut icon" href="<cfoutput>pictures/albumcover/small/#Replace(album.Artist,' ','%20','ALL')#-#Replace(album.Name,' ','%20','ALL')#</cfoutput>.jpg">
<link rel="apple-touch-icon" href="<cfoutput>pictures/albumcover/small/#Replace(album.Artist,' ','%20','ALL')#-#Replace(album.Name,' ','%20','ALL')#</cfoutput>.jpg">
...
<meta property="og:description" content="<cfoutput>#album.Artist#</cfoutput> (sound artist) <cfoutput>#album.VisualArt#</cfoutput> (visual artist)">
...
<!---
<meta property="og:audio" content="http://<cfoutput>#cgi.server_name#/MP3320/050000.mp3</cfoutput>">
...
<TD><CFIF FileExists('#GetDirectoryFromPath(ExpandPath("*.*"))#/pictures/albumcover/small/#trim(album.Artist)#-#trim(album.Name)#.jpg')><cfoutput><A HREF="pictures/albumcover/#trim(album.Artist)#-#URLencodedFormat(trim(album.Name))#.jpg" target="_blank"><IMG  SRC="pictures/albumcover/small/#album.Artist#-#URLencodedFormat(trim(album.Name))#.jpg"  BORDER="0" name='SlideShow' title='[Object] "#album.Artist#-#trim(general.Name)#'></A></cfoutput><CFELSE><IMG SRC="pictures/albumcover/small/generic.jpg" name='SlideShow' ALIGN="TOP" ></CFIF></TD>
...
<CFSET AlbumIcon = 'pictures/icons/generic.jpg' >
   ...
   <TR>
      ...
      <TD VALIGN="TOP" nowrap=1><STRONG>#album.Artist#</STRONG><cfif trim(album.Other) NEQ ''><br><i>#Replace(album.Other,',','<br>','ALL')#</i></cfif></TD>
   </TR>
...
<TR><TD><TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="100%">
<TR>
<TD COLSPAN="2" CLASS="style3"><CFINCLUDE TEMPLATE="linernotes/#general.AlbumID#.htm"></TD>
</TR>
</TABLE></TD></TR>
</CFIF>
...
<TD CLASS="style2cTrans"><cfoutput>[#trim(general.Name)#]<STRONG> <A HREF="pictures/albumcover/#album.Artist#-#URLencodedFormat(trim(general.Name))#.jpg">Cover</A></STRONG></cfoutput></TD>
